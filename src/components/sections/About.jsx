...
const highlights = [
  ...
  { icon: <FiCpu size={20} />, label: 'Problem Solver', desc: '192+ LeetCode problems' },
      ...
      <div ref={ref} className="grid lg:grid-cols-5 gap-10 items-center">
        ...
        >
          <p className="text-gray-300 text-base leading-relaxed">
            I'm <span className="text-brand-400 font-semibold">Abirami S</span>, a B.Tech Information Technology student at Sri Eshwar College of Engineering, deeply passionate about engineering products that create real impact. I specialize in the <span className="text-brand-400 font-semibold">MERN Stack</span> and Java-based backend development.
          </p>
          ...
          <p className="text-gray-400 text-base leading-relaxed">
            I'm particularly excited about <span className="text-violet-400 font-medium">AI integration</span>, <span className="text-violet-400 font-medium">scalable system design</span>, and building solutions that directly address societal challenges — like reducing food waste and improving accessibility to education.
          </p>
          <div className="flex flex-wrap gap-2 pt-2">
            {['MERN Stack', 'Spring Boot', 'Java', 'DSA', 'REST APIs', 'MySQL', 'MongoDB'].map(tag => (
